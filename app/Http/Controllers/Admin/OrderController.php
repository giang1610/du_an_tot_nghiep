   ...
   public function checkout(Request $request)
{
    ...
    protected function initiateMomoPayment($order, $amount)
    {
        ...
        $rawHash = "accessKey={$config['access_key']}&amount={$amount}&extraData=&ipnUrl={$config['ipn_url']}&orderId={$orderId}&orderInfo={$orderInfo}&partnerCode={$config['partner_code']}&redirectUrl={$config['redirect_url']}&requestId={$requestId}&requestType={$requestType}";
