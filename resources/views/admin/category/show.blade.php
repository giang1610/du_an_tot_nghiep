            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" 
                           placeholder="Ví dụ: Điện thoại di động" value="{{ old('name', $category->name) }}" disabled>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex">
                        ...
                        <input type="text" name="slug" id="slug" class="form-control slug-input" 
                               placeholder="Tự động tạo từ tên danh mục" value="{{ old('slug', $category->slug) }}" disabled>
                    </div>
                    @error('slug')
                        <div class="text-danger"><i class="bi bi-exclamation-circle-fill me-1"></i> {{ $message }}</div>
                    @enderror
