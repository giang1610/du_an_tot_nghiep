            ...
            <form action="{{ route('users.createStaff') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" name="email" class="form-control" value="{{ $user->email }}" autocomplete="off" disabled>
                        @error('email')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    {{-- <div class="col-md-6">
                        ...
                        <input type="password" name="password" class="form-control" autocomplete="new-password" value="{{ $user->password }}" disabled>
                        @error('password')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div> --}}
                ...
                <div class="mb-3">
                   ...
                   <div class="mt-2">
                        <div class="mt-2">
                        <img id="img_thumbnail_preview" 
                            src="{{ asset('storage/' . $user->img_thumbnail) }}" 
                            alt="{{ $user->name }}" 
