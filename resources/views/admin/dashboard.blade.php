                    ...
                    <div class="row">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-end">
                                    ...
                                    @if($revenueStats['today_percent_change'] >= 0)
                                        <span class="text-success small"><i class="bi bi-arrow-up"></i> {{ abs($revenueStats['today_percent_change']) }}%</span>
                                    @else
                                        <span class="text-danger small"><i class="bi bi-arrow-down"></i> {{ abs($revenueStats['today_percent_change']) }}%</span>
                                    @endif
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 mb-3 mb-md-0">
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-end">
                                    <h4 class="mb-0 me-2">{{ number_format($revenueStats['weekly_percent_change']) }} VNĐ</h4>
                                    @if($revenueStats['weekly_percent_change'] >= 0)
                                        <span class="text-success small"><i class="bi bi-arrow-up"></i> {{ abs($revenueStats['weekly_percent_change']) }}%</span>
                                    @else
                                        <span class="text-danger small"><i class="bi bi-arrow-down"></i> {{ abs($revenueStats['weekly_percent_change']) }}%</span>
                                    @endif
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 mb-3 mb-md-0">
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-end">
                                    <h4 class="mb-0 me-2">{{ number_format($revenueStats['monthly_percent_change']) }} VNĐ</h4>
                                    @if($revenueStats['monthly_percent_change'] >= 0)
                                        <span class="text-success small"><i class="bi bi-arrow-up"></i> {{ abs($revenueStats['monthly_percent_change']) }}%</span>
                                    @else
                                        <span class="text-danger small"><i class="bi bi-arrow-down"></i> {{ abs($revenueStats['monthly_percent_change']) }}%</span>
                                    @endif
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-end">
                                    <h4 class="mb-0 me-2">{{ number_format($revenueStats['yearly_percent_change']) }} VNĐ</h4>
                                    @if($revenueStats['yearly_percent_change'] >= 0)
                                        <span class="text-success small"><i class="bi bi-arrow-up"></i> {{ abs($revenueStats['yearly_percent_change']) }}%</span>
                                    @else
                                        <span class="text-danger small"><i class="bi bi-arrow-down"></i> {{ abs($revenueStats['yearly_percent_change']) }}%</span>
                                    @endif
                                </div>
                            </div>
                        </div>
            ...
            <div class="card metric-card metric-success h-100">
                <div class="card-body">
                    ...
                    <div class="progress mb-3" style="height: 6px;">
                        <div class="progress-bar bg-success" style="width: {{ $orderStats['completed_percentage'] }}%"></div>
                        <div class="progress-bar bg-danger" style="width: {{ $orderStats['cancelled_percentage'] }}%"></div>
                        <div class="progress-bar bg-warning" style="width: {{ $orderStats['pending_percentage'] }}%"></div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('revenuePeriod').addEventListener('change', function() {
        ...
        // You would typically make an AJAX call here to fetch new data
