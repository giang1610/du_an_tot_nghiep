    ...
    <div class="container-fluid py-4">
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        ...
                        <button type="button" class="btn btn-sm btn-light" data-bs-toggle="collapse" data-bs-target="#filterCard">
                    ...
                    <div class="card-body collapse show" id="filterCard">
                        <form action="{{ route('admin.reports.revenue') }}" method="GET">
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <label class="form-label"><i class="bi bi-calendar-range me-1"></i> Khoảng thời gian</label>
                                    <select name="time_period" class="form-select select2">
                                        <option value="today" {{ request('time_period') == 'today' ? 'selected' : '' }}>Hôm nay</option>
                                        <option value="yesterday" {{ request('time_period') == 'yesterday' ? 'selected' : '' }}>Hôm qua</option>
                                        <option value="this_week" {{ request('time_period') == 'this_week' ? 'selected' : '' }}>Tuần này</option>
                                        <option value="last_week" {{ request('time_period') == 'last_week' ? 'selected' : '' }}>Tuần trước</option>
                                        <option value="this_month" {{ request('time_period') == 'this_month' ? 'selected' : '' }}>Tháng này</option>
                                        <option value="last_month" {{ request('time_period') == 'last_month' ? 'selected' : '' }}>Tháng trước</option>
                                        <option value="this_year" {{ request('time_period') == 'this_year' ? 'selected' : '' }}>Năm nay</option>
                                        <option value="last_year" {{ request('time_period') == 'last_year' ? 'selected' : '' }}>Năm trước</option>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="compare_with" class="form-select select2">
                                        ...
                                        <option value="same_period_last_week" {{ request('compare_with') == 'same_period_last_week' ? 'selected' : '' }}>Cùng kỳ tuần trước</option>
                                        <option value="same_period_last_month" {{ request('compare_with') == 'same_period_last_month' ? 'selected' : '' }}>Cùng kỳ tháng trước</option>
        ...
        <div class="alert alert-info">
            <div class="d-flex">
                ...
                <div class="flex-fill">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <strong>Khoảng thời gian:</strong> <span id="report-date-range">{{ $fromDate }} - {{ $toDate }}</span>
                        </div>
                        <div class="col-md-4">
                            <strong>Tổng số ngày:</strong> <span id="report-days-count">{{ $daysCount }}</span> ngày
                        </div>
                        <div class="col-md-4">
                            <strong>Ngày tạo báo cáo:</strong> <span id="report-generation-date">{{ now()->format('d/m/Y H:i') }}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-bs-toggle="collapse" data-bs-target="#overviewStats">
                                ...
                                <div class="info-box shadow-sm">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">
                                            ...
                                            @if($compareData)
                                            <small class="text-{{ $summary->total_orders > $compareData->summary->total_orders ? 'success' : 'danger' }}">
                                ...
                                <div class="info-box shadow-sm">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">
                                            ...
                                            @if($compareData)
                                            <small class="text-{{ $summary->total_revenue > $compareData->summary->total_revenue ? 'success' : 'danger' }}">
                                                {{ $summary->total_revenue > $compareData->summary->total_revenue ? '+' : '' }}{{ number_format($summary->total_revenue - $compareData->summary->total_revenue) }} VNĐ 
                                ...
                                <div class="info-box shadow-sm">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">
                                            ...
                                            @if($compareData)
                                            <small class="text-{{ $summary->avg_order_value > $compareData->summary->avg_order_value ? 'success' : 'danger' }}">
                                                {{ $summary->avg_order_value > $compareData->summary->avg_order_value ? '+' : '' }}{{ number_format($summary->avg_order_value - $compareData->summary->avg_order_value) }} VNĐ 
                                ...
                                <div class="info-box shadow-sm">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">
                                            ...
                                            @if($compareData)
                                            <small class="text-{{ $summary->total_discount > $compareData->summary->total_discount ? 'success' : 'danger' }}">
                                                {{ $summary->total_discount > $compareData->summary->total_discount ? '+' : '' }}{{ number_format($summary->total_discount - $compareData->summary->total_discount) }} VNĐ 
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="info-box shadow-sm bg-light">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">{{ number_format($summary->subtotal) }} VNĐ</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="info-box shadow-sm bg-light">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">{{ number_format($summary->total_tax) }} VNĐ</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="info-box shadow-sm bg-light">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">{{ number_format($summary->total_shipping) }} VNĐ</span>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0"><i class="bi bi-bar-chart me-2"></i>Biểu đồ doanh thu theo ngày</h5>
                        <div class="card-tools">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="payment-methods-tab" data-bs-toggle="tab" data-bs-target="#payment-methods" type="button" role="tab" aria-controls="payment-methods" aria-selected="true">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="statuses-tab" data-bs-toggle="tab" data-bs-target="#statuses" type="button" role="tab" aria-controls="statuses" aria-selected="false">
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">{{ number_format($category->total_revenue) }} VNĐ</td>
                                                        <td>
                                                            <div class="progress" style="height: 8px;">
                                                                <div class="progress-bar bg-success" role="progressbar" style="width: {{ $percentage }}%" aria-valuenow="{{ $percentage }}" aria-valuemin="0" aria-valuemax="100"></div>
                                                            </div>
                                                    ...
                                                    <tr class="table-light">
                                                        <th>Tổng cộng</th>
                                                        <th class="text-end">{{ number_format($revenueByCategory->sum('total_quantity')) }}</th>
                                                        <th class="text-end">{{ number_format($totalCategoryRevenue) }} VNĐ</th>
                                                        <th>100%</th>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">{{ number_format($product->total_revenue) }} VNĐ</td>
                                                <td>
                                                    <div class="progress" style="height: 8px;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="text-center">
                                                            ...
                                                            @endphp
                                                            <span class="badge bg-{{ $badgeColor }}">{{ $status->status_name }}</span>
                                                        </td>
                                        ...
                                        <div class="info-box shadow">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number">
                                                    ...
                                                    <small class="text-muted">{{ $customerLoyalty->total_customers > 0 ? number_format(($customerLoyalty->new_customers / $customerLoyalty->total_customers) * 100, 1) : 0 }}%</small>
                                                </span>
                                        ...
                                        <div class="info-box shadow">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number">
                                                    ...
                                                    <small class="text-muted">{{ $customerLoyalty->total_customers > 0 ? number_format(($customerLoyalty->returning_customers / $customerLoyalty->total_customers) * 100, 1) : 0 }}%</small>
                                                </span>
                                        ...
                                        <div class="info-box shadow">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number">
                                                    ...
                                                    <small class="text-muted">{{ $customerLoyalty->total_customers > 0 ? number_format(($customerLoyalty->loyal_customers / $customerLoyalty->total_customers) * 100, 1) : 0 }}%</small>
                                                </span>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <tr>
                                                            ...
                                                            <td class="text-end">{{ number_format($customerLoyalty->total_customers) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Khách hàng mới (lần đầu):</th>
                                                            <td class="text-end">{{ number_format($customerLoyalty->new_customers) }} ({{ $customerLoyalty->total_customers > 0 ? number_format(($customerLoyalty->new_customers / $customerLoyalty->total_customers) * 100, 1) : 0 }}%)</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Khách quay lại (lần 2):</th>
                                                            <td class="text-end">{{ number_format($customerLoyalty->returning_customers) }} ({{ $customerLoyalty->total_customers > 0 ? number_format(($customerLoyalty->returning_customers / $customerLoyalty->total_customers) * 100, 1) : 0 }}%)</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Khách thân thiết (3+ lần):</th>
                                                            <td class="text-end">{{ number_format($customerLoyalty->loyal_customers) }} ({{ $customerLoyalty->total_customers > 0 ? number_format(($customerLoyalty->loyal_customers / $customerLoyalty->total_customers) * 100, 1) : 0 }}%)</td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                                $percentage = $totalVoucherUsage > 0 ? ($voucher->usage_count / $totalVoucherUsage) * 100 : 0;
                                            @endphp
                                            <tr>
                                                <td class="text-center">
                                                ...
                                                <td class="text-end">{{ number_format($voucher->usage_count) }}</td>
                                                <td class="text-end">{{ number_format($voucher->total_discount) }} VNĐ</td>
                                                <td>
                                                    <div class="progress" style="height: 8px;">
                                            ...
                                            <tr class="table-light">
                                                ...
                                                <th class="text-end">{{ number_format($totalVoucherDiscount) }} VNĐ</th>
                                                <th>100%</th>
                                            </tr>
                                            @else
                                            <tr>
                                                <td colspan="6" class="text-center">Không có dữ liệu voucher</td>
                                            </tr>
                                            @endif
                                        </tbody>
                                    </table>
                            ...
                            <div class="tab-pane fade" id="inventory" role="tabpanel" aria-labelledby="inventory-tab">
                                    ...
                                    <div class="col-md-3">
                                        <div class="info-box shadow">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number">{{ number_format($inventoryStats->total_products) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="info-box shadow">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number">
                                                    {{ number_format($inventoryStats->in_stock_products) }}
                                                    <small class="text-muted">{{ $inventoryStats->total_products > 0 ? number_format(($inventoryStats->in_stock_products / $inventoryStats->total_products) * 100, 1) : 0 }}%</small>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="info-box shadow">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number">
                                                    {{ number_format($inventoryStats->out_of_stock_products) }}
                                                    <small class="text-muted">{{ $inventoryStats->total_products > 0 ? number_format(($inventoryStats->out_of_stock_products / $inventoryStats->total_products) * 100, 1) : 0 }}%</small>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="info-box shadow">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number">{{ number_format($inventoryStats->total_inventory_value) }} VNĐ</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="card-title">Thống kê tồn kho</h5>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <tr>
                                                            ...
                                                            <td class="text-end">{{ number_format($inventoryStats->total_variants) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Tỷ lệ sản phẩm có hàng:</th>
                                                            <td class="text-end">{{ $inventoryStats->total_products > 0 ? number_format(($inventoryStats->in_stock_products / $inventoryStats->total_products) * 100, 1) : 0 }}%</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Tỷ lệ sản phẩm hết hàng:</th>
                                                            <td class="text-end">{{ $inventoryStats->total_products > 0 ? number_format(($inventoryStats->out_of_stock_products / $inventoryStats->total_products) * 100, 1) : 0 }}%</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Giá trị tồn kho trung bình:</th>
                                                            <td class="text-end">{{ $inventoryStats->total_products > 0 ? number_format($inventoryStats->total_inventory_value / $inventoryStats->total_products) : 0 }} VNĐ/sản phẩm</td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            </div>
