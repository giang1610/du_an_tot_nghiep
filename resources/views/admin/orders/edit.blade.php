    ...
    <div class="container-fluid px-4">
        <nav aria-label="breadcrumb" class="mt-2">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('orders.index') }}" style="text-decoration: none">Danh sách
                        đơn hàng</a></li>
                ...
                <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-2 mt-2">
                                    ...
                                    @foreach($mediaList as $media)
                                        ...
                                        @elseif(Str::endsWith($media, ['.mp4', '.mov']))
                                            <video src="{{ asset('storage/' . $media) }}" controls width="200"
                    ...
                    <form action="{{ route('orders.handleReturn', $order->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="note_admin" id="note_admin" rows="3"
                                class="form-control">{{ $order->note_admin }}</textarea>
                        </div>
                    ...
                    <div class="card h-100 border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control bg-light" value="{{ $order->order_number }}"
                                    readonly>
                            </div>
                            <div class="mb-3">
                            ...
                            <div>
                                ...
                                <input type="text" class="form-control bg-light fw-bold"
                                    value="{{ number_format($order->total) }} VNĐ" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card h-100 border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control bg-light"
                                    value="{{ $order->user->name ?? 'Khách vãng lai' }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label text-muted small mb-1">Email</label>
                                <input type="text" class="form-control bg-light" value="{{ $order->customer_email }}"
                                    readonly>
                            </div>
                            <div>
                                <label class="form-label text-muted small mb-1">Số điện thoại</label>
                                <input type="text" class="form-control bg-light" value="{{ $order->customer_phone }}"
                                    readonly>
                            </div>
                        </div>
                    </div>
